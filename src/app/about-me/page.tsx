          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-orange-500/20">
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-xl text-gray-200 leading-relaxed mb-6">
                Hi, I'm Andrew and I'm from a small village in Romania. I am a student at the local school. About one year ago, I reached my peak: I had great friends, high grades, and everything was going as planned.
              </p>
              
              <p className="text-xl text-gray-200 leading-relaxed mb-6">
                But then, in December 2024, something hit me. I realized that I don't just want to be that normal guy, I wanted something different. That one thought changed everything. I knew I had to do something.
              </p>
              ...
              <p className="text-xl text-gray-200 leading-relaxed mb-6">
                But then I discovered affiliate marketing and AI. That's when everything changed. I realized I could combine the power of artificial intelligence with affiliate marketing to create something truly revolutionary.
              </p>
              
              <p className="text-xl text-gray-200 leading-relaxed mb-6">
                That's how AFFILIFY was born. A platform that makes affiliate marketing as easy as playing a video game. With AI-powered website generation, advanced analytics, and everything you need to succeed - all in one place.
              </p>
              
              <p className="text-xl text-gray-200 leading-relaxed">
                Today, AFFILIFY helps thousands of people build successful affiliate businesses. From students like me to experienced marketers, everyone can now create professional affiliate websites in minutes, not months.
              </p>
            </div>
          </div>
        </div>
